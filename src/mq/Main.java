...
public class Main extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TODO : DEL // ZMQService.setUrl("warzazat3");
        // TODO : DEL // ZMQService.url = "warzazat";
        zmqService = new Intent(this, ZMQService.class);
        startService(zmqService);
        // TODO : DEL // ZMQService.url = "warzazat2";
        ...
        switch (requestCode) {
            case REQ_CODE_SPEECH_INPUT: {
                if (resultCode == RESULT_OK && null != data) {
                    ...
                    String ip = SP.getString("dmg_ip", "");    // TODO : use a R. for the default value
                    String port = SP.getString("dmg_pub_port", "40411");    // TODO : use a R. for the default value
