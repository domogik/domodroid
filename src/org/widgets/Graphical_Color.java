...
import org.colorpicker.Color_Progress;
import org.colorpicker.Color_RGBField;
import org.colorpicker.Color_Result;
...
public class Graphical_Color extends FrameLayout implements OnSeekBarChangeListener{
	...
	public Graphical_Color(Context context, SharedPreferences params, int dev_id, String name, final String state_key, String url,String usage, int update, int widgetSize) {
		super(context);
		this.dev_id = dev_id;
