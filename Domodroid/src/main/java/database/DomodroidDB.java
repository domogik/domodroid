...
public class DomodroidDB {
    ...
    public void insertArea(JSONObject json) throws JSONException {
        ...
        //activity.getContentResolver().insert(DmdContentProvider.CONTENT_URI_CLEAR_AREA, null);
    ...
    public void insertRoom(JSONObject json) throws JSONException {
        ...
        //activity.getContentResolver().insert(DmdContentProvider.CONTENT_URI_CLEAR_ROOM, null);
    ...
    public void insertIcon(JSONObject json) throws JSONException {
        ...
        //activity.getContentResolver().insert(DmdContentProvider.CONTENT_URI_CLEAR_ICON, null);
        ...
        for (int i = 0; i < itemArray.length(); i++) {
            ...
            activity.getContentResolver().insert(DmdContentProvider.CONTENT_URI_INSERT_ICON, values);
        }
    }
    ...
    public void insertFeature(JSONObject json) throws JSONException {
        ...
        for (int i = 0; i < itemArray.length(); i++) {
            try {
                ...
                activity.getContentResolver().insert(DmdContentProvider.CONTENT_URI_INSERT_FEATURE, values);
            } catch (Exception e) {
    ...
    public void insertFeatureAssociation(JSONObject json) throws JSONException {
        ...
        //activity.getContentResolver().insert(DmdContentProvider.CONTENT_URI_CLEAR_FEATURE_ASSOCIATION, null);
    ...
    public void insertFeatureState(JSONObject json) throws JSONException {
        ...
        for (int i = 0; i < itemArray.length(); i++) {
            ...
            if (curs.getInt(0) == 0) {
                ...
                activity.getContentResolver().insert(DmdContentProvider.CONTENT_URI_INSERT_FEATURE_STATE, values);

            } else {
                Tracer.e(mytag + "(" + owner + ")", "Update for : " + dev_id + " (" + skey + ") (" + Val + ")");
                activity.getContentResolver().update(DmdContentProvider.CONTENT_URI_UPDATE_FEATURE_STATE, values, "device_id = ? AND key = ?",
    ...
    public void insertFeatureState(JSONObject json) throws JSONException{
		...
		activity.getContentResolver().insert(DmdContentProvider.CONTENT_URI_CLEAR_FEATURE_STATE, null);
    ...
    public void insertFeatureMap(int id, int posx, int posy, String map) {
        ...
        values.put("map", map);
        activity.getContentResolver().insert(DmdContentProvider.CONTENT_URI_INSERT_FEATURE_MAP, values);
    }
    ...
    public void remove_one_place_type_in_Featureassociation(int place_id, String place_type) {
        ...
        values.put("place_id", place_id);
        values.put("place_type", place_type);
        activity.getContentResolver().insert(DmdContentProvider.CONTENT_URI_CLEAR_one_place_type_in_FEATURE_ASSOCIATION, values);
    }
    ...
    public void cleanFeatureMap(String map) {
        ...
        ContentValues values = new ContentValues();
        values.put("map", map);
        activity.getContentResolver().insert(DmdContentProvider.CONTENT_URI_CLEAR_FEATURE_MAP, values);
    }
    ...
    public void update_name(int id, String name, String type) {
        switch (type) {
            case "feature": {
                ...
                activity.getContentResolver().insert(DmdContentProvider.CONTENT_URI_UPDATE_FEATURE_NAME, values);
                break;
            }
            case "area": {
                ContentValues values = new ContentValues();
                ...
                activity.getContentResolver().insert(DmdContentProvider.CONTENT_URI_UPDATE_AREA_NAME, values);
                break;
            }
            case "room": {
                ContentValues values = new ContentValues();
                ...
                activity.getContentResolver().insert(DmdContentProvider.CONTENT_URI_UPDATE_ROOM_NAME, values);
                break;
            }
            case "icon": {
                ContentValues values = new ContentValues();
    ...
    public void move_one_feature_association(int id, int place_id, String place_type, String order) {
        ...
        activity.getContentResolver().insert(DmdContentProvider.CONTENT_URI_UPDATE_FEATURE_POSITION_ID, values);
    ...
    public void move_one_area(int id, int place_id, String place_type, String order) {
        ...
        values.put("place_type", place_type);
        values.put("order", order);
        activity.getContentResolver().insert(DmdContentProvider.CONTENT_URI_UPDATE_AREA_POSITION_ID, values);
    ...
    public void move_one_room(int id, int place_id, String place_type, String order) {
        ...
        values.put("place_type", place_type);
        values.put("order", order);
        activity.getContentResolver().insert(DmdContentProvider.CONTENT_URI_UPDATE_ROOM_POSITION_ID, values);
    ...
    public Entity_Room[] requestallRoom() {
        ...
        Cursor curs = null;
        try {
            curs = activity.getContentResolver().query(DmdContentProvider.CONTENT_URI_REQUEST_ROOM,
                    projection,
                    null,
                    null,
                    "id Asc");
    ...
    public int[] requestAllFeatures_association() {
        ...
        try {
            ...
            curs1 = activity.managedQuery(DmdContentProvider.CONTENT_URI_REQUEST_FEATURE_ASSOCIATION_ALL, null, null, null, null);
            curs2 = activity.managedQuery(DmdContentProvider.CONTENT_URI_REQUEST_FEATURE_MAP_ALL, null, null, null, null);
    ...
    public int requestidlastFeature_association() {
        ...
        int lastid = 0;
        try {
            curs = activity.getContentResolver().query(DmdContentProvider.CONTENT_URI_REQUEST_FEATURE_ASSOCIATION,
                    projection,
                    null,
                    null,
                    null);
    ...
    public Entity_Room[] requestRoom(int area_id) {
        ...
        Cursor curs = null;
        try {
            //curs = activity.managedQuery(DmdContentProvider.CONTENT_URI_REQUEST_ROOM, projection, "area_id = \'"+area_id+"\'", null, null);
            curs = activity.getContentResolver().query(DmdContentProvider.CONTENT_URI_REQUEST_ROOM,
                    projection,
                    "area_id = ?",
                    new String[]{area_id + ""},
    ...
    public Entity_Icon requestIcons(int reference, String name) {
        ...
        try {
            ...
            curs = activity.managedQuery(DmdContentProvider.CONTENT_URI_REQUEST_ICON, projection, "reference = ? AND name = ?", new String[]{reference + "", name}, null);
            curs.moveToFirst();
    ...
    public Entity_Feature[] requestFeatures(int id, String zone) {
        ...
        try {
            curs = activity.managedQuery(DmdContentProvider.CONTENT_URI_REQUEST_FEATURE_ID, null, null, new String[]{id + " ", zone}, "state_key ");
    ...
    public Entity_Map[] requestFeatures(String map) {
        ...
        try {
            ...
            curs = activity.managedQuery(DmdContentProvider.CONTENT_URI_REQUEST_FEATURE_MAP, projection,
                    "table_feature_map = ?",
                    new String[]{"\'" + map + "\' "},
                    null);
    ...
    public Entity_Map[] requestMapSwitches(String map) {
        ...
        try {
            //Tracer.v(mytag+"("+owner+")","Getting database features for map : "+map);
            //Getting database features for map current map
            curs = activity.managedQuery(DmdContentProvider.CONTENT_URI_REQUEST_MAP_SWITCHES, projection,
                    "table_feature_map = ?",
                    new String[]{"\'" + map + "\' "},
                    null);
    ...
    public Entity_Feature[] requestFeatures() {
        ...
        try {
            ...
            curs = activity.managedQuery(DmdContentProvider.CONTENT_URI_REQUEST_FEATURE_ALL, null, null, null, null);
            features = new Entity_Feature[curs.getCount()];
            int count = curs.getCount();
            for (int i = 0; i < count; i++) {
                curs.moveToPosition(i);
